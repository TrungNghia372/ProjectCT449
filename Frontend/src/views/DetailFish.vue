        ...
        <div class="product">
            <div class="detailProduct">
                ...
                <div class="infProduct">
                    ...
                    <h5 class="habitatOfProduct">
                        {{fish.habitat==='nuoc man'?'Nước mặn':'Nước ngọt'}}
                    </h5>
                    <p>
                    {{fish.popularType?'Phổ biến':'Không phổ biến'}}
                    </p>
...
<script>
    ...
    import Suggest from '../components/suggest/suggestFish.vue';
    ...
    export default {
        ...
        methods: {
            async getFishDetail() {
                ...
                const result = await axios.get('http://localhost:4000/api/fish/detailFish/detail',
                    {
                        params: {
