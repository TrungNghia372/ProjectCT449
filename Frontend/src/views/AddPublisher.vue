<template>
    <div class="add">
      ...
      <div class="container">
        <div class="titlee">
          <h1 style="font-family:Verdana, Geneva, Tahoma, sans-serif">THÊM NHÀ XUẤT BẢN</h1>
        </div>
        ...
        <form action="" method="post">
          ...
          <div class="buttonbook">
            ...
            <button type="button" class="btn btn-info" @click="addPublisher()">Thêm</button>
  ...
  export default {
    ...
    methods: {
      async addPublisher() {
        try {
          const result = await axios.post('http://localhost:4000/api/publisher/addpublisher', {
            name: this.name,
